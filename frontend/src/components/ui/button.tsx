 ...
 * [data-theme]. This is the migration target that the existing src/ui/Button.jsx
 * will eventually wrap (see docs/shadcn-migration.md) — it is NOT yet wired into
 * the app; it ships as a proof component for the foundation.
 */
